...
class newqLearningAgent:
    def __init__(self, alpha=0.1, gamma=0.9, epsilon=0.1, is_train=False):
        ...
        if is_train:
            ...
            self.load_q_table("Agent/qlearning/Q_traditional2.npy")
    ...
    def save_q_table(self, filename="Q_traditional2.npy"):
...
if __name__ == "__main__":
    rounds = 100000
    try:
        agent = newqLearningAgent(is_train=True)
        print("Starting training...")
        agent.train(rounds)
        print("Training complete. Saving Q-table...")
        agent.save_q_table("Q_traditional2.npy")
